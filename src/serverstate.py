...
NATIONALITY_GREETINGS = {
    'DE': ["^2Hallo", "^2Moin", "^2Servus", "^2Guten Tag"],
    'RU': ["^1Privet", "^1Zdravstvuyte", "^1Privet vsem"],
    'FR': ["^4Salut", "^4Bonjour", "^4Bonsoir", "^4Salut tout le monde"],
    'US': ["^1Hi", "^1Hey", "^1Hello"],
    'PL': ["^1Czesc", "^1Siema", "^1Witajcie", "^1Hej"],
    'SE': ["^3Hej", "^3Tjena", "^3Hej allihopa"],
    'GB': ["^5Hello", "^5Cheers", "^5Alright lads"],
    'NL': ["^2Hoi", "^2Hallo", "^2Goedendag"],
    'FI': ["^5Moi", "^5Terve", "^5Hei kaikille"],
    'NO': ["^1Hei", "^1Hallo", "^1Hei alle sammen"],
    'CZ': ["^1Ahoj", "^1Cau", "^1Nazdar", "^1Zdar"],
    'SK': ["^4Ahoj", "^4Cau", "^4Nazdar", "^4Zdar"],
    'UA': ["^3Pryvit", "^3Pryvit vsim"],
    'BR': ["^2Opa", "^2E ai", "^2Ola", "^2Fala galera"],
    'AU': ["^2G'day", "^2G'day mate", "^2Oi oi"],
    'CA': ["^1Hi", "^1Hey", "^1Hello"],
    'IT': ["^2Ciao", "^2Salve", "^2Ciao a tutti"],
    'ES': ["^1Hola", "^1Buenas", "^1Que tal"],
    'DK': ["^1Hej", "^1Goddag", "^1Hej allesammen"],
    'BE': ["^3Hallo", "^3Salut", "^3Hey"],
    'AT': ["^1Servus", "^1Gruss Gott"],
    'CH': ["^1Gruezi", "^1Hoi", "^1Sali"],
    'PT': ["^2Ola", "^2Boas"],
    'HU': ["^1Szia", "^1Hello", "^1Sziasztok"],
    'RO': ["^3Salut", "^3Buna"],
    'BG': ["^2Zdravei", "^2Zdrasti", "^2Zdraveite"],
    'HR': ["^1Bok", "^1Pozdrav"],
    'RS': ["^4Zdravo", "^4Cao"],
    'EE': ["^4Tere", "^4Hei"],
    'LV': ["^1Sveiki", "^1Čau"],
    'LT': ["^3Labas", "^3Sveiki"],
    'JP': ["^1Konnichiwa", "^1Yo"],
    'KR': ["^4Annyeong", "^4Bangapseumnida"],
    'CN': ["^1Ni hao"],
    'GR': ["^4Geia", "^4Geia sou"],
    'TR': ["^1Merhaba", "^1Selam"],
    'IL': ["^4Shalom", "^4Ahalan"],
    'BY': ["^1Pryvitanne", "^1Zdorov", "^1Vitaju"],
}
